...
Algunos Movimientos incluyen efectos, muchos de estos con una probabilidad de activarse. En esos casos, la Descripción indica el intervalo de resultados necesario para que cada efecto ocurra. Por ejemplo, **[[Colmillo Hielo]]** indica: _"1-10 [[Pokémon/Características Pokémon/Problemas de Estado/Problemas de Estado Mayores/Congelado|Congelar]] al objetivo. 11-20 Deja [[Pokémon/Características Pokémon/Problemas de Estado/Problemas de Estado Menores/Aturdido|Aturdido]] al objetivo."_
...
- **[[Físico]]:** Representa Movimientos que dependen de la fuerza, el contacto directo o el impacto del cuerpo del Pokémon. Los Movimientos [[Físico|Físicos]] suman el **[[Pokémon/Características Pokémon/Características Pokémon|Bonificador de Característica]]** de **[[Pokémon/Características Pokémon/Características/Atk|Ataque Físico]]** del usuario a la **Potencia** del ataque y se enfrentan a la **[[Pokémon/Características Pokémon/Características/Def|Defensa Física]]** del objetivo.
- **[[Especial]]:** Representa Movimientos que manifiestan energía elemental, poderes sobrenaturales o capacidades que no dependen de la fuerza física. Los Movimientos [[Especial|Especiales]] suman el **[[Pokémon/Características Pokémon/Características Pokémon|Bonificador de Característica]]** de **[[Pokémon/Características Pokémon/Características/SpAtk|Ataque Especial]]** del usuario a la **Potencia** del ataque y se enfrentan a la **[[Pokémon/Características Pokémon/Características/SpDef|Defensa Especial]]** del objetivo.
...
- **Dados de Daño.** Indican la cantidad y el tipo de dados que se lanzan para determinar el daño base del Movimiento. Por cada nivel del **[[Reglas/Bonificador de Experiencia|Bonificador de Experiencia]]** por encima de **+1**, el Movimiento obtiene un dado adicional del mismo tipo. Por ejemplo, un Pokémon con un Bonificador de Experiencia de **+3** que utilice un Movimiento de **1d8** lanzará **3d8**.
- **Bonificadores.** Todo Movimiento ofensivo añade el **[[Pokémon/Características Pokémon/Características Pokémon|Bonificador de la Característica]]** correspondiente, según la Clase del Movimiento. Además de este, un movimiento puede recibir otros bonificadores externos como su **STAB**, entre otros
...
- [[Reglas/Bonificador de Experiencia|Bonificador de Experiencia]]